...
const validation = yup.object({
    ...
    telephone: yup.string().required("Please enter your phone number!").matches(/^(\+\d{2,3}\s)?\(?\d{4}\)?[\s.-]\d{3}[\s.-]\d{2}[\s.-]\d{2}$/, "Example: 0555 555 55 55"),
    guests: yup.number().min(1, "There must be at least 1 guest!").required("Please enter number of guests per table!"),
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
            <fieldset>
                ...
                <div className="field">
                    ...
                    <input type="tel" placeholder="0555 555 55 55" name="telephone" {...register("telephone")}/>
